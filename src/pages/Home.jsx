...
function Home() {
  ...
  return (
    <>
      <Navbar />
      <div className="bg-[#282C35!] scrollbar-hide z-10 h-[100vh] w-full lg:mx-auto overflow-y-hidden shadow-2xl">
        <div className="flex">
          {!showProfile ? (
            <div className="md:flex md:flex-col min-w-[360px] h-[100vh] md:h-[98.6vh] bg-[#166e48] relative">
              <div className="h-[61px] px-4">
                <div className="flex">
                  <a
                    ...
                    href="/"
                  >
                    <h3 className="text-[20px] text-white font-body font-extrabold tracking-wider">
                      Messages
                    </h3>
                  </a>
                </div>
